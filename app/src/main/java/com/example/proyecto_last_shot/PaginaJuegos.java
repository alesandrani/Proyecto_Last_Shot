...
/**
 * Actividad principal de selección de juegos. Permite al usuario elegir entre
 * diferentes juegos,
 * acceder a información de cada uno y navegar entre pantallas.
 */
public class PaginaJuegos extends AppCompatActivity {
   ...
   * Inicializa las vistas, configura los listeners de los botones y muestra los
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    infoMechero.setOnClickListener(view -> mostrarDialogo("Mechero",
        "El juego comienza con un jugador aleatorio que tiene el mechero (marcado en el chat). " +
    ...
    infoVerdadReto.setOnClickListener(view -> mostrarDialogo("Verdad o Reto",
        "Un juego dinámico donde los jugadores son seleccionados aleatoriamente para elegir entre verdad o reto. " +
    ...
    infoNumeroMaestro.setOnClickListener(view -> mostrarDialogo("Número Maestro",
        "Cada jugador recibirá un número aleatorio que saldrá en el chat general, el que tenga el número más bajo bebe."));
  ...
  /**
   * Selecciona aleatoriamente uno de los juegos disponibles y abre su actividad
   * correspondiente.
   */
